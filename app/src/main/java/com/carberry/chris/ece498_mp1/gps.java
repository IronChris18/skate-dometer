...
class gps extends FragmentActivity implements LocationListener,
    ...
    private static final long MIN_TIME = 1000;   //update in milliseconds
    private static final float MIN_DISTANCE = 10;//update in meters
...
/*    private GoogleMap.OnMyLocationChangeListener myLocationChangeListener = new GoogleMap.OnMyLocationChangeListener() {
    ...
    public void onLocationChanged(Location location) {
        ...
        CameraUpdate update = CameraUpdateFactory.newLatLngZoom(current, 19);
